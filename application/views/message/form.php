...
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">message Form</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="content-box">
					<form id="form-action">
						...
						<div class="form-group" style="width: 33%; float: left; ">
							...
							<input class="form-control" name="tousername"  type="text" disabled>
							
						</div>
                                               
                          <div class="form-group" style="width: 33%; float: left; ">
							<label for="">From Member</label>
							<input class="form-control" name="fromusername"  type="text" disabled>   
							 </div>
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'message/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'message/action'; ?>", formData).done(function(data) {
                   // alert(data);
