	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Message</div>
			</div>
			<div class="row">
				<div class="col-md-12">
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url			        : "<?php echo base_url() . 'message/data'; ?>",
		primaryField			: 'id', 
		rowNumber			: true,
                itemsPerPage			: 10,
		...
		columns					: 
                [
					{field: 'tousername', title: 'To', editable: true, sortable:  false, width: 10, align: 'left', search: true},
		  {field: 'fromusername', title: 'From', editable: true, sortable:  false, width: 10, align: 'left', search: true},
                
				  {field: 'contents', title: 'Message', editable: true, sortable: false, width:100, align: 'left', search: true},
				  {field: 'create_time', title: 'Time', editable: true, sortable: false, width:10, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'message/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'message/delete'; ?>", {id : row.id}).done(function(data) {
				location.reload();
			});
		});
	}
