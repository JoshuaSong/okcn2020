	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Role</div>
			</div>
			<div class="row">
				<div class="col-md-12">
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		...
		columns					: [
		{field: 'name', title: 'Role Title', editable: true, sortable: true, width: 100, align: 'left', search: true},
                {field: 'remark', title: 'Info', editable: true, sortable: true, width: 450, align: 'left', search: true},
