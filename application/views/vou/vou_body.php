    ...
    <div class="sb-slidebar sb-right">
      <nav>
		<ul class="sb-menu">
			...
			<li class="sb-close" style="height: 50px;"><img src="/src/images/user_icon.png" style="height: 40px;">userID: </li>
			<li class="sb-close"><a>계정 설정</a> </li>
			<li class="sb-close"><a>올린 사연</a></li>
			<li class="sb-close"><a>청취한 프로그램</a></li>
			<li class="sb-close"><a>나누었던 프로그램</a></li>
...
<script>
    ...
    Kakao.Link.createDefaultButton({
      ...
      objectType: 'feed',
      content: {
           title: '통일의 소리 방송입니다.방송 프로그램 하나 소개합니다.《<?php echo  $first->program_title;?>》 입니다.',
           description:'진행에 <?php echo  $first->actor_name;?> 입니다.',
            imageUrl: '<?php echo  $first->channel_poster;?>',
     link: {
          mobileWebUrl: 'http://okcnradio.org/vou/p/<?php echo  $first->p_id;?>',
          webUrl: 'http://okcnradio.org/vou/p/<?php echo  $first->p_id;?>'
        }
      },
