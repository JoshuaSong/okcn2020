        ...
        <div class="page" data-name="home">
          ...
          <div class="navbar" style="background-color:#a82a21;">
            <div class="navbar-inner">
              ...
              <div class="left">
                <img src="/images/okcn_logo_w.png" style="width: 30px; margin-left: 20px;" >
                <a href="#" class="link icon-only panel-open" data-panel="left" style="color:#fff; padding-left: 5px; font-size: 24px; font-weight: 500;">
                 OKCN
                </a>
              </div>
          ...
          <div class="page-content">
            ...
            <div class="toolbar tabbar toolbar-top" style="position:fixed; max-width: 370px;">
    <div class="toolbar-inner">
      <a href="#tab-1" class="tab-link tab-link-active">편성/영상</a>
      <a href="#tab-2" class="tab-link">예배</a>
      <a href="#tab-3" class="tab-link">선교지</a>
      <a href="#tab-4" class="tab-link">모퉁이돌</a>
      <a href="#tab-5" class="tab-link">24시간 찬양</a>
    </div>
  </div>
  <div class="tabs">
    <div id="tab-1" class="page-content tab tab-active" style="padding: 60px 10px 0px 10px">

        <div class="fullBackground" >
         <table style="width: 100%;  background-color:#000;  color:#fff;  opacity: 0.7; height: 25px;"><tr>
           ...
           <td style="vertical-align: middle;  font-size: 12px;  line-height: 1;">
            ...
            <span><?php echo $today[0]->programs->program_title?></span></td>
              ...
              <div style=" width: 100%; background-color:#fff;  color:#000;  opacity: 0.9; height: 25px; position:absolute; bottom: 0px; left: 0;">
          
               <p class="marquee"> <?php echo $today[0]->programs->summary?></p> 
              </div>
         
        </div>

        <div class="section" style="border-bottom: 0;margin-top: 220px;">
          <a href="#" class="button button-raised button-fill popup-open" data-popup="#my-popup">기도에 동참</a>
...
-->
    ...
    <div id="tab-2" class="page-content tab" style="padding: 60px 0 0 0">
    
      <div class="section-content">
                                <div class="row" style="margin: 0;">
                                    <?php foreach ($this->CI->okcn_model->getChannelByCat(1) as $row) { ?>
                                        <div class="col-4">
                                            <a href="/catalog/" class="item-content item-link">
                                                <img style="border-radius: 5px; width: 100%;" src="<?php echo $row->channel_poster; ?>">
                                            </a>
                                            <div class="item-title" style="overflow: hidden;text-overflow:ellipsis; white-space: nowrap; font-size: 14px;"><?php echo $row->channel_title; ?></div>
