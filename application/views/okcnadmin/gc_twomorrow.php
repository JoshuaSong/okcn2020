	...
	display:none;
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<center>
          	<?php if($data['canpublish']) { if($data['published']) {?>
          		
          			<h3>Published!</h3>
          			<?php } else {?>
          			<h3><a href="/okcnadmin/publish12/<?php echo  $data['publish_url']; ?>">Publish Now!</a></h3>	
          		<?php }} else {?>
          			<h3>Cannot Publish now, need upload more!</h3>
          			<?php } ?>
          </center>
