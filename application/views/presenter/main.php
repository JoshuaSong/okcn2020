	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Presenter</div>
			</div>
			<div class="row">
				<div class="col-md-12">
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'presenter/data'; ?>",
		primaryField			: 'a_id', 
		rowNumber				: true,
                itemsPerPage			: 10,
		...
		columns					: [
		{field: 'actor_name', title: '이름', editable: true, sortable: true, width: 200, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'presenter/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'presenter/delete'; ?>", {id : row.a_id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
