...
<body class="home2">
        ...
        <div class="header-top-area">
            ...
            <div class="mainmenu-area">
                <div class="container">
                    <div class="menu">
                        <ul>
                            <li class="active"><a href="<?php echo base_url() ?>home">Home <i class="fa fa-angle-down"></i><span>start here</span></a>
                            </li>
    ...
    <section class="album-area section-padding">
        <div class="container">
            <center>
    	<div id="poster" style="width: 100%; max-width: 700px; min-height: 900px; margin-bottom: 50px; background-image: url(<?php echo base_url() ?>src/images/tbg.png);background-repeat: repeat" >
...
<!--OnAir Table          -->    	
    	<table id="onairTable" class="commhide"  style="color:#ffffff; padding: 10px; margin: 10px; width: 95%; font-size: 16px" cellpadding="5px"><tr>
    ...
    <a id="kakao-link-btn" href="javascript:;" >
      <img src="<?php echo base_url() ?>images/katalkshare.png" onclick="sharewithkakao(<?php echo $item->p_id;?>)" style="width:120px; padding-top: 50px;"/>
    </a>
    </center>
    		<div id="time"></div>
    ...
    <section class="main-container" id="contact" style="padding-bottom: 80px; padding-top: 30px; background-color: #212020; color: white; margin-top: 60px">
		<div class="container">
    ...
    <script>
    Kakao.init('b06563ee077e54da0ebff2b1194bf23c');
    Kakao.Link.createDefaultButton({
         ...
         content: {
           ...
           imageUrl: '',
           link: {
             mobileWebUrl: '<?php echo base_url() ?>',
             webUrl: '<?php echo base_url() ?>'
           }
         },
         buttons: [
           {
