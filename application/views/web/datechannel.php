...
<body class="home2">
    ...
    <section class="album-area section-padding">
    	...
    	<div style="width: 100%; " ><image id="posterImg"  class="commhide" src="<?php echo $current->radio_image;?>" style=" width: 100%; "></image></div>
...
<!--OnAir Table          -->    	
    	...
    	foreach ($todays as $item): ?>
			<tr id="tr<?php echo $item->id;?>"  mediaurl="<?php echo $item->radio_url;?>"  class= "channelTR">
				<td onclick="trclick(<?php echo $item->id;?>)" class="mediaTD"><img id="img<?php echo $item->id?>" class="media" src="<?php echo base_url() ?>src/images/play.png" /></td>
				<td id="tt<?php echo $item->id;?>" class="titleTD" ><span><?php echo $item->program_date.'  《'.$item->category_name.'》'.$item->radio_name.'';?></span>
			</td>
	 	<td width="30px;" onclick="sharech(<?php echo $item->id;?>)"><image src="<?php echo base_url() ?>src/images/share.png" style="width: 20px;"></image></td>
		</tr>
		<?php $i++; ?>
<?php endforeach; ?>
    	</table>
