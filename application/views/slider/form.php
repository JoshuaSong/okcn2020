...
<script type="text/javascript">
	...
	var onLoad = (function() {
		...
		if (index != '') {
			...
			$('#slide-image').show().attr('src',row.banners_image);
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'slider/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	//	alert(formData);
		$.post("<?php echo base_url() . 'slider/action'; ?>", formData).done(function(data) {
