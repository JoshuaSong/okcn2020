				...
				<div class="content-box">
					...
					<table class="table table-striped table-bordered tree">
						<?php foreach ($groups as $key => $group) { ?>
							<tr>
								<td class="list-group" id="<?php echo $group->Id; ?>"><?php echo $group->name; ?></td>
                                                                <td style="color:#aaa;"><?php echo $group->remark; ?></td>
							</tr>
						<?php } ?>
					</table>
				</div>
	...
	$(document).ready(function() {
		...
		$("input[type='checkbox']").each(function() {
			$(this).on("click", function() {
				...
				$.post("<?php echo base_url() . 'privilegeUser/action'; ?>", {group_id: group_id, arr_id: arrId});
			});
		});
		...
		$(".list-group").each(function() {
			$(this).on("click", function() {
				...
				$.post("<?php echo base_url() . 'privilegeUser/load'; ?>", {group_id: this.id}).done(function(data) {
