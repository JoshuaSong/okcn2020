...
//$config['licenseName'] = 'jmdsong';
//$config['licenseKey']  = 'X1V3-ABCV-2868-R3HE-G6KZ-NQFK-5QKM';
//ocwuser
//*Z?2-*1**-H**6-*J**-*T**-B*D*-2**K
//注册机:      https://putong.la/ckfinder3.html
$config['licenseName'] = 'bbhomesus';
$config['licenseKey']  = '*U?W-*1**-3**1-*3**-*J**-3*9*-2**B';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/assets/ckfinder/userfiles1/',
